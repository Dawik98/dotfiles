...
awful.spawn.with_shell("ps aux | grep \"pactl subscribe\" | grep -v grep | awk '{print $2}' | xargs kill")
awful.spawn.with_shell("ps aux | grep \"grep\" | grep -v grep | awk '{print $2}' | xargs kill")
...
-- TODO
-- Open dmenu when you start typing on wallpaper
